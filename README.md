...
* Readable Image Formats:
    ...
    * GIF
    * PIC
    * PKM 1.0/2.0 (direct ETC1, ETC2, and EAC upload)
...
These direct loaders do not decode or transcode. PKM and standalone ASTC files
contain one 2D image without mipmaps, cubemap faces, texture-array layers, or
orientation metadata. Unsupported GPU formats fail with a descriptive error.
